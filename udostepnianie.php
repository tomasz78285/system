...
<html lang="pl">
    ...
    <body>
        <main>
            ...
            <br><br>
                <div class = "container">
                 <h1>Wybierz ankietę, którą chcesz udostępnić</h1>
                    <div class="row">
                           ...
                           <?php
                                    ...
                                    if($result && $result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                            ?> 
                                            <a href="http://localhost/System_ankietyzacji_online/metoda_udostepniania.php?nazwa=<?php echo $row['nazwa_ankiety']; ?>"> <?php echo $row["nazwa_ankiety"];?> </a> <br> 
                                            <?php "<br>";                                       
                                             }
                                    } else {
                                        echo "0 results";
