...
<html lang="pl">
    ...
    <?php
        ...
        if(isset($_POST['nazwa_ankiety']) &&  isset($_POST['P1'])  && isset($_POST['P101'])) 
        {
            ...
            {
                $polaczenie->query("INSERT INTO ankiety(nazwa_ankiety, grupa_badawcza, dostepnosc ,autor) VALUES ('$nazwa_ankiety','Edukacja','$dost', '$autor')");
                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div id="scenter3">
                            ...
                            <input type="text" name="grupa_badawcza" value="Edukacja" disabled>
                    ...
                    <div id=scenter3>
                        <div class="row">
                                <div class="col-sm-1"><span style="font-weight:700;">Pytanie1</span><br>
                                        <input type="text" name="P1" value="Czy w Twojej szkole jesteś dobrze traktowany/a?"><br><br>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie2</span><br>
                                <input type="text" name="P2" value="W jakich formach przebiegają zajęcia w Twojej szkole?"><br><br>
                                <input type="text" value="Monolog nauczyciela" name="P201"><br>
                                <input type="text" value="Praca indywidualna" name="P202"><br>
                                <input type="text" value="Praca w grupach" name="P203"><br>
                                <input type="text" value="Tworzenie projektów" name="P204"><br>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie3</span><br>
                                <input type="text" name="P3" value="Jak często spotykasz się z przemocą w szkole?"><br><br>
                                <input type="text" value="Bardzo często" name="P301"><br>
                                <input type="text" value="Często" name="P302"><br>
                                <input type="text" value="Czasami" name="P303"><br>
                                <input type="text" value="Rzadko" name="P304"><br>
                                <input type="text" value="Bardzo rzadko" name="P305"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie4</span><br>
                                <input type="text" name="P4" value="Czy jesteś zadowolony ze swoich postępów w nauce?"><br><br>
