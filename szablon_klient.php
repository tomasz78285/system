...
<html lang="pl">
    ...
    <?php
        ...
        if(isset($_POST['nazwa_ankiety']) &&  isset($_POST['P1'])  && isset($_POST['P101'])) 
        {
            ...
            {
                $polaczenie->query("INSERT INTO ankiety(nazwa_ankiety, grupa_badawcza, dostepnosc ,autor) VALUES ('$nazwa_ankiety','Klient','$dost', '$autor')");
                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div id="scenter3">
                            ...
                            <input type="text" name="grupa_badawcza" value="Klient" disabled>
                    ...
                    <div id=scenter3>
                        <div class="row">
                                <div class="col-sm-1"><span style="font-weight:700;">Pytanie1</span><br>
                                        <input type="text" name="P1" value="Czy jesteś zadowolony/a z zakupionego produktu?"><br><br>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie2</span><br>
                                <input type="text" name="P2" value="Jak oceniasz produkt w skali 1-5?"><br><br>
                                <input type="text" value="1" name="P201"><br>
                                <input type="text" value="2" name="P202"><br>
                                <input type="text" value="3" name="P203"><br>
                                <input type="text" value="4" name="P204"><br>
                                <input type="text" value="5" name="P205"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie3</span><br>
                                <input type="text" name="P3" value="Co zmieniłbyś/aś w tym produkcie?"><br><br>
                                <input type="text" value="Jakość wykonania" name="P301"><br>
                                <input type="text" value="Cenę" name="P302"><br>
                                <input type="text" value="Ilość" name="P303"><br>
                                <input type="text" value="Produkt jest świetny, nic nie trzeba zmieniać" name="P304"><br>
                                <input type="text" value="Produkt jest fatalny, należy go wycofać ze sprzedaży" name="P305"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie4</span><br>
                                <input type="text" name="P4" value="Czy poleciłbyś/aś ten produkt innym?"><br><br>
