...
<html lang="pl">
    ...
    <?php
        ...
        if(isset($_POST['nazwa_ankiety']) &&  isset($_POST['P1'])  && isset($_POST['P101'])) 
        {
            ...
            {
                $polaczenie->query("INSERT INTO ankiety(nazwa_ankiety, grupa_badawcza, dostepnosc ,autor) VALUES ('$nazwa_ankiety','$gr_badawcza','$dost', '$autor')");
                    ...
                    $polaczenie->query("INSERT INTO odpowiedzi (numer, nr_w_ankiecie, tresc_odpowiedzi, ilosc, pytanie, ankieta) VALUES 
                                                                                        ('1','1','$P101','0','$P1','$nazwa_ankiety'),
                                                                                        ('2','2','$P102','0','$P1','$nazwa_ankiety'),
                                                                                        ('3','1','$P201','0','$P2','$nazwa_ankiety'),
                                                                                        ('4','2','$P202','0','$P2','$nazwa_ankiety'),
                                                                                        ('5','3','$P203','0','$P2','$nazwa_ankiety'),
                                                                                        ('6','4','$P204','0','$P2','$nazwa_ankiety'),
                                                                                        ('7','5','$P205','0','$P2','$nazwa_ankiety'),
                                                                                        ('8','1','$P301','0','$P3','$nazwa_ankiety'),
                                                                                        ('9','2','$P302','0','$P3','$nazwa_ankiety'),
                                                                                        ('10','3','$P303','0','$P3','$nazwa_ankiety'),
                                                                                        ('11','4','$P304','0','$P3','$nazwa_ankiety'),
                                                                                        ('12','5','$P305','0','$P3','$nazwa_ankiety'),
                                                                                        ('13','1','$P401','0','$P4','$nazwa_ankiety'),
                                                                                        ('14','2','$P402','0','$P4','$nazwa_ankiety')");
                    ...
                    <div id=scenter3>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie3</span><br>
                                ...
                                <input type="text" value="Wyższe" name="P304"><br>
                                <input type="text" value="Brak" name="P305"><br>
                            </div>
                        </div>
