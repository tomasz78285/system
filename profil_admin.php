                    ...
                    <div class="row">
                            ...
                            <div class=col-sm-5 id="n2">
                                    <ul>
                                        ...
                                        <li class="l2"><a href="udostepnianie.php">Udostępnij ankietę</a></li>
                                        <li class="l2"><a href="statystyki.php">Statystyki</a></li>
                                        <li class="l2"><a href="ustawienia_konta.php">Ustawienia konta</a></li>
                                        <li class="l2"><a href="zarzadzaj_ankietami.php">Zarządzaj ankietami</a></li>
                                        <li class="l2"><a href="rejestracja_admin.php">Dodaj administratora</a></li>  
                            ...
                            <div class="col-sm-5" id="s10">
                                Kontent <br>
                                <?php
                                    echo "<p>Witaj ".$_SESSION['user']." (nie jesteś ".$_SESSION['user'].'? <a href="wyloguj.php">Wyloguj się</a>)<br><br>W tej zakładce masz możliwość zmian ustawień konta. Masz tu również podgląd na wyniki swoich ankiet. Możesz zarządzać ankietami czy też dodać nowych administratorów.</p>';
                                ?>    
                            </div>
                        </div>
                    </div>
