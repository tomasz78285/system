                    ...
                    <div id=scenter3>
                        ...
                        <div class="row">
                                <div class="col-sm-1"><span style="font-weight:700;">Pytanie1</span><br>
                                        <input type="text" name="P1" value="Jaki okres będzie Panu/Pani njabardziej odpowiadał?"><br><br>
                                        <input type="text" value="Letni" name="P101"><br>
                                        <input type="text" value="Zimowy" name="P102"><br>
                                </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie2</span><br>
                                <input type="text" name="P2" value=" Preferuje Pan/Pani, by miejsce imprezy było?"><br><br>
                                <input type="text" value="W firmie" name="P201"><br>
                                <input type="text" value="Nad morzem" name="P202"><br>
                                <input type="text" value="W górach" name="P203"><br>
                                <input type="text" value="Nad jeziorem" name="P204"><br>
                                <input type="text" value="Za granicą" name="P205"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie3</span><br>
                                <input type="text" name="P3" value="Jaki rodzaj zabawy by Panu/Pani odpowiadał?"><br><br>
                                <input type="text" value="Ognisko" name="P301"><br>
                                <input type="text" value="Karaoke" name="P302"><br>
                                <input type="text" value="DJ" name="P303"><br>
                                <input type="text" value="Grill" name="P304"><br>
                                <input type="text" value="Inne" name="P305"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie4</span><br>
                                <input type="text" name="P4" value="Jak długi okres integracji Pan/Pani preferuje?"><br><br>
                                <input type="text" value="Jednodniowy" name="P401"><br>
                                <input type="text" value="Kilkudniowy" name="P402"><br>
                                <br><br>
