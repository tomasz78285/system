...
<html lang="pl">
    ...
    <?php
        ...
        if(isset($_POST['nazwa_ankiety']) &&  isset($_POST['P1'])  && isset($_POST['P101'])) 
        {
            ...
            {
                $polaczenie->query("INSERT INTO ankiety(nazwa_ankiety, grupa_badawcza, dostepnosc ,autor) VALUES ('$nazwa_ankiety','Pracownik','$dost', '$autor')");
                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div id="scenter3">
                            ...
                            <input type="text" name="grupa_badawcza" value="Pracownik" disabled>
                    ...
                    <div id=scenter3>
                        <div class="row">
                                <div class="col-sm-1"><span style="font-weight:700;">Pytanie1</span><br>
                                        <input type="text" name="P1" value="Czy jesteś zadowolony/a ze swojej pracy?"><br><br>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie2</span><br>
                                <input type="text" name="P2" value="Na jakim stanowsiku pracujesz?"><br><br>
                                <input type="text" value="Pracownik" name="P201"><br>
                                <input type="text" value="Kierownk" name="P202"><br>
                                <input type="text" value="Dyrektor" name="P203"><br>
                                <input type="text" value="Project manager" name="P204"><br>
                        ...
                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie3</span><br>
                                <input type="text" name="P3" value="Co zmieniłbyś/aś w swojej pracy?"><br><br>
                                <input type="text" value="Wynagrodzenie" name="P301"><br>
                                <input type="text" value="Godziny pracy" name="P302"><br>
                                <input type="text" value="Premie" name="P303"><br>
                                <input type="text" value="Stosunek przełożonych" name="P304"><br>
                                <input type="text" value="Nic" name="P305"><br>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-1"><span style="font-weight:700;">Pytanie4</span><br>
                                <input type="text" name="P4" value="Czy kiedykolwiek spotkałeś się z dyskryminacją w pracy??"><br><br>
